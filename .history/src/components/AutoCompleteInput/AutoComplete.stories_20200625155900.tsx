...
import AutoComplete,{DataSourceType} from './AutoComplete2'
...
const AutoCompleteWithAsyncData = () => {
  ...
  return <AutoComplete fetchSuggestion={querySearch} renderOption={renderOption} onSelect={action('clicked')} />
}
...
const AutoCompleteWithSyncData = () =>{
  ...
  return (
    <>
    <AutoComplete fetchSuggestion={fetchSuggestion} onSelect={action('selected')}/>
    </>
  )
}
