...
const Button: React.FC<ButtonProps> = (props) => {
  const { className, disabled, btnType, size, children, href, onClick, ...restProps } = props
  ...
  if (btnType === "link" && href) {
    ...
    return (
      <button className={classes} disabled={disabled} {...restProps} onClick={onClick}>{children}</button>
    )
  }
}
