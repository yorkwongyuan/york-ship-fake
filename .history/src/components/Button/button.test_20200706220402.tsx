...
import Button, { ButtonProps } from './yk-button'
...
describe('test button', () => {
  ...
  it('should render a link,when btnType equals link and href is provided', () => {
    const wrapper = render(<Button btnType="link" href="http://hehe">Link</Button>)
  ...
  it('should render disabled button when disabled set to be true', () => {
    ...
    fireEvent.click(element)
    expect(disabledProps.onClick).not.toHaveBeenCalled() // disabled 了,所以按键无效
  })
})