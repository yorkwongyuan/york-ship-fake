import React, { createContext, useState, FC, Children, cloneElement, FunctionComponentElement } from 'react';
...
const Menu: FC<MenuProps> = (props) => {
  ...
  const renderChildren = () => {
    return Children.map(children, (child, index) => {
      const el = child as FunctionComponentElement<MenuItemProps>
