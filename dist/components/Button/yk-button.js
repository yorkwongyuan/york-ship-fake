...
export var Button = function (props) {
    var _a;
    var className = props.className, disabled = props.disabled, btnType = props.btnType, size = props.size, children = props.children, href = props.href, restProps = __rest(props, ["className", "disabled", "btnType", "size", "children", "href"]);
    var classes = ClassNames('btn', className, (_a = {},
        _a["btn-" + btnType] = btnType,
        _a["btn-" + size] = size,
        _a['disabled'] = (btnType === "disabled" && disabled),
        _a));
